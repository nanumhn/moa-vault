- [★★★★★2026-09-10 14:36 오후 세션 시작 스냅샷(최신)](project_open_threads_2026-09-10_afternoon_snapshot.md) — 14:00 저장예약이 못 돌아 사후 복원. 덱스 폴더선택창에 또 멈춤·아투결함③ 추측단계·매출 측정실패
...
- [★★★★★아투 게이트 이중경로 — 수리가 커밋 안 됨 + 회귀테스트가 헛통과](project_atz_gate_dual_path_disparity_2026-09-06.md) — 09-07 재확인. checkout 한 번에 되돌아감. 시험 픽스처가 "미국 관세청"이라 자기면역, 실제 문구 "관세청"으로 바꿔야 실패함
