- [★★★★★2026-08-26 늦은오전 스냅샷(최신)](project_open_threads_2026-08-26_late_morning_snapshot.md) — ★**형 결재 7건 대기** · 003 결론=PDF단품 불가(24,000개 실측, 돈은 "만들어주는 것"에) · 001 배포직전 결함(2·3번이 **매일** 같은 내용) · 004 프로브완성/UI대기 · **클로 오류 5건·형 지적 6회 원문**
...
- [★★★★★창 제목은 식별자가 아니다 — 같은 PID가 덱스/제나를 번갈아 답한다](reference_window_title_is_not_an_identifier_2026-08-26.md) — 09:07 "MOA-dex" → 09:43 "MOA-jena", **같은 pid 10396**. 이것 때문에 형께 "제나 창 없음" 오보를 올렸다. ★생존은 **말을 걸어** 확인 · 이름+경로로 잡기 · node.exe는 CommandLine까지 봐야 갈림
