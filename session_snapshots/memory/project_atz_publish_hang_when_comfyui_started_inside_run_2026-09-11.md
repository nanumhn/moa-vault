...
**09-13 재발(2번째 사례)**: 04:28 재부팅 복구에서 ComfyUI 단계 T6 TIMEOUT(recovery_timeline.log) → 05:31 8188 꺼짐 확인 → 사전기동 결재 REQ-20260913-ATZ001-01 올렸으나 형 무응답(05:55 조회). 06:00 발행이 `06:00:07 ComfyUI down → 기동` → `06:03:11 UP` 후 `[servers]` 줄 없이 멈춤(06:06 atz_pipeline.log 끝줄=“slot=am 시작”, pid 17156 CPU 0.34초, 작업결과 267009). 중지→재실행 결재 REQ-20260913-ATZ001-02 올림. 같은 부팅에 관리자 락 사고도 재발(REQ-20260913-MGR001-02). **교훈: 재부팅 복구에서 ComfyUI가 TIMEOUT이면 05:30 전에 결재부터 올려야 06:00에 맞출 수 있다.**
